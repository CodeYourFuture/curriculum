---
title: First 90 days
description: How to succeed in your first 90 days
emoji: 📔
weight: 4
---

This guide will give you some suggestions on how to hit the ground running in your first 90 days of a tech job.
...
For more advice on lifelong learning see our [learning guide](../learning). In your first 90 days the amount of things to learn can be overwhelming, so it is useful to have a plan for what you want to focus on and discuss it with your manager. This will typically a combination of
- The parts of the system your team is responsible for
- What your team is working on right now
- Any upskilling in particular languages or technologies you need for your role

You should also not underestimate the value of learning about the wider context, what the company sells and its different products and business model as this will help you find the right solutions to problems you encounter.
...
Look for tasks that you can quickly succeed at early on to demonstrate your value to the team. In an engineering role often the best way to understand how the system and processes work is to complete a very small change and follow it all the way through to production. You could also suggest an improvement to a team process or offer to help out with any other problem you see your team struggling with that you think you can help with. Being engaged and pro-active and showing you are a team player will help you to build positive relationships with your colleagues.
