...
description = "Build, monitor, and observe systems using event-driven architectures."
layout = "module"
track_kinds = ["jobs-after-sdc"]
menu = ["event-driven-architecture"]
weight = 3
+++
...
* Completed the [Software Development Course](https://curriculum.codeyourfuture.io/sdc/)
