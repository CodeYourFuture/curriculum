...
If you have already learned to [deploy your apps from github using Netlify](../deployment/netlify), you can use the same process to deploy any React apps you created initially with create-react-app.
