...
Open the [Accessibility and the DOM demo page](/workshops/accessibility-and-the-dom) and follow the steps on the page. You will run a Lighthouse audit in Navigation mode, then add some elements and run a Snapshot audit, and compare what each one finds.
