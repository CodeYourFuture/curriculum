...
As covered in [step three](https://curriculum.codeyourfuture.io/itd/steps/three/), generative AI tools such as ChatGPT can be a great help in your studies with CodeYourFuture. However, the way you use them is very important. These tools can just as easily be a great obstacle to your learning if you let them do your thinking for you.
...
Use an AI tool to help you solve the problem. This can mean asking it to explain concepts, provide examples, explain code, etc. It must not mean copying code from the AI or blindly following its advice without understanding why. You may wish to look at [step three](https://curriculum.codeyourfuture.io/itd/steps/three/) again and search resources for using AI appropriately. If you're stuck, Google or ask in the #step-7-questions-support channel on Slack.

> [!NOTE]
> You will need to submit a link to your AI chat, so please use an AI tool which allows for chats to be shared by link, such as ChatGPT, Claude or Gemini.
> **Never share sensitive information within a AI chat**

#### 4. Self Check

Look over the code you have written.

1. Do you understand it all? Can you explain it out loud?
1. Has any code been pasted from an AI tool or elsewhere?
1. What worked and what didn’t work when prompting the AI?
