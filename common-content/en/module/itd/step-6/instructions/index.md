...
{{<note type="tip" title="Ask the Internet">}}

- Need to choose a **professional GitHub username**? Ask an AI assistant for tips on picking one that's clear, simple, and career-friendly. (_Does it give a different response if you ask "how to pick a username" vs "how to pick a clear, simple and career-friendly GitHub username" - what is that difference?_)
- Curious **why a professional username matters**? Use a search engine to find out how it can impact your credibility, discoverability, and personal brand.
...
Before you start uploading files, use AI to explore some key concepts and terminology. Understanding these will make GitHub easier to use.

> [!CAUTION]
>
> Remember what we mentioned in [Step Three](https://curriculum.codeyourfuture.io/itd/steps/three/)!
> AI output is always worth **verifying** with our own Google searches. See if you can validate the AI's output via internet articles and blogs.
...
{{<note type="tip" title="Ask the Internet">}}
While editing the `README.md`, using a search engine or AI, ask these questions to understand the file better:
...
{{<note type="tip" title="Ask the Internet">}}
If you're not sure where to find your links, try finding out with a search engine or AI:
