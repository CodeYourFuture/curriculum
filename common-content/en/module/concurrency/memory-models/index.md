...
You can see estimated speeds of different memory (and other) read operations in ["Latency Numbers Every Programmer Should Know"](https://gist.github.com/jboner/2841832). Read this and make sure you understand it. This suggests that reading from shared main memory is 100-1000x slower than reading from a per-core L1 cache.
