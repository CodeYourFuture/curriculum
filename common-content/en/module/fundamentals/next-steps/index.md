...
[objectives]
    ...
    2='Locate the prep, backlog, day plan, and end of sprint review pages on the curriculum'
...
Then spend {{<timer>}}15{{</timer>}} completing the following tasks. When you're done, spend {{<timer>}}15{{</timer>}} discussing any challenges you had and making sure you're ready for the week.
...
1. Check the end of sprint review page for the next sprint. What are we trying to help the trainees to achieve?
...
1. In the day-plan for the upcoming sprint, identify the instructions for any workshops. Check the instructions make sense.
