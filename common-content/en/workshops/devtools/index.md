...
time = 60
# TODO: Ideally this would be automatically gathered from the inline ```objectives not duplicated
objectives = [
    "Inspect the DOM",
...
- [ ] This [Devtools Workshop page](/workshops/devtools/)
...
1.  [Inspect the page](/workshops/devtools/) with Devtools.
...
1. Set a [whole class timer for 10 minutes](https://www.google.com/search?q=timer+for+10+minutes).
2. Inspect the [CSS of the page](/workshops/devtools/) with Devtools.
...
1. Set a [whole class timer for 10 minutes](https://www.google.com/search?q=timer+for+10+minutes).
2. With Devtools, locate a grid element on [the workshop page](/workshops/devtools/).
...
1. Set a [whole class timer for 10 minutes](https://www.google.com/search?q=timer+for+10+minutes).
1. Run a Lighthouse audit on [the workshop page](/workshops/devtools/).
