...
- [Getting setup](#getting-setup-💻) - 5 mins
- [Answering questions](#answering-questions-❓) - 20 mins
- [Whole group discussion](#whole-group-discussion) - 10 mins
- [Review time](#review-time) - 15 mins
...
To begin with, **Person 1** **fork** [the workshop code repository](https://github.com/CodeYourFuture/workshop-code) and **clone** it to your local machine.
...
You'll find the first question in the `questions-and-reviews/questions/0.md` file in your fork of the workshop code repository
