...
objectives = [
   ...
   "Get the length of an array in code.",
   "Predict what an array will contain after a series of `push`, `pop`, and `shift` operations.",
   "Iterate over the items in an array using a `for..of` loop.",
]
[build]
  list = "local"
...
The content for this workshop workshop can be found here 👉 https://github.com/CodeYourFuture/workshop-code/tree/main/arrays/
...
➡️ [Go to Level 100](https://github.com/CodeYourFuture/workshop-code/blob/main/arrays/100.js)
